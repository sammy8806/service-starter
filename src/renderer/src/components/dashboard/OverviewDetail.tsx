          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="text-left text-[11px] uppercase tracking-wider text-zinc-500 bg-zinc-800/50">
                <th scope="col" className="px-4 py-2.5 font-medium">Port</th>
                <th scope="col" className="px-4 py-2.5 font-medium">Label</th>
                ...
                portRows.map((row) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2.5 font-mono text-[11px] text-zinc-500">
                      {row.process ? `${row.process}${row.pid !== undefined ? ` (${row.pid})` : ''}` : '—'}
                    </td>
                  </tr>
                ))
              )}
